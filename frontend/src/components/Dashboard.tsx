    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-100">
          ...
          <div className="space-y-3">
            {topReferidos.map((ref, idx) => (
              <div key={ref.id} className="flex items-center justify-between p-3 rounded-lg border border-slate-100 hover:bg-slate-50 transition">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-indigo-600 font-semibold">+${comisionDeReferido(ref).toFixed(2)}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-100">
          ...
          <p className="text-slate-500 text-sm mb-4">{referidosDirectos} referidos directos. El nivel se calcula con:</p>
