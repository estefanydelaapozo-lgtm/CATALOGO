  ...
  if (!pedido) {
    return (
      <div className="bg-white p-10 rounded-lg border border-slate-200 text-center">
        ...
        <Link to="/tienda" className="inline-block bg-indigo-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-indigo-700 transition">
          Volver a la Tienda
        </Link>
      </div>
    );
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <span className="text-2xl font-bold text-green-600">${pedido.total.toFixed(2)}</span>
          </div>

          <div className="flex gap-4">
            <Link to="/tienda" className="flex-1 text-center bg-indigo-600 text-white font-semibold py-3 rounded-lg hover:bg-indigo-700 transition">
              Seguir Comprando
            </Link>
            <Link to="/catalogo" className="flex-1 text-center border border-slate-300 text-slate-700 font-semibold py-3 rounded-lg hover:bg-slate-50 transition">
              Ver Catálogo
            </Link>
          </div>
        </div>
